          ...
          <div className="border-t border-border pt-8 flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex gap-8 mt-4 md:mt-0">
              ...
              <a href="https://wa.me/905378475859" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-2 text-muted-foreground hover:text-green-500 transition">
                <svg className="w-6 h-6 text-green-500" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.67-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.076 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421-7.403h-.004a9.87 9.87 0 00-4.968 1.495c-2.573 1.66-4.738 4.744-4.738 7.88 0 3.137 2.165 6.221 4.738 7.881 1.532.99 3.32 1.495 4.968 1.495 3.355 0 6.4-1.623 8.235-4.236 1.835-2.613 1.835-6.144 0-8.757-1.835-2.613-4.88-4.236-8.235-4.236zm0-2c5.079 0 9.408 2.582 11.674 6.265 2.266 3.683 2.266 8.332 0 12.015-2.266 3.683-6.595 6.265-11.674 6.265-1.823 0-3.583-.365-5.247-1.073C2.604 21.702 0 19.603 0 17v-5.5C0 8.119 2.604 6.02 5.027 5.27 6.59 4.662 8.177 4.379 9.551 4.379z" />
                </svg>
