          ...
          <div className="border-t border-border pt-8 flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex gap-8 mt-4 md:mt-0">
              ...
              <a href="https://wa.me/905378475859" target="_blank" rel="noopener noreferrer" className="group flex flex-col items-center gap-2">
                <div className="relative p-3 rounded-full border-2 border-green-500 bg-green-500/10 group-hover:bg-green-500/20 group-hover:shadow-lg group-hover:shadow-green-500/50 transition-all duration-300">
                  <svg className="w-6 h-6 text-green-500" fill="currentColor" viewBox="0 0 24 24">
